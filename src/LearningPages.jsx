...
const SETUP_STEPS=[
  ...
  {icon:FolderGit2,title:'2. Create the practice repository',body:'Create one workspace, initialize Git, and add the folders Episteme will use.',commands:['mkdir Practice','cd Practice','git init','mkdir projects','mkdir .episteme','Set-Content .gitignore -Value @(".venv/", ".env", "__pycache__/", "*.pyc")','New-Item projects/.gitkeep -ItemType File',`Set-Content .episteme/projects.json '{"schema_version":1,"projects":[]}'`,`Set-Content .episteme/curriculum.json '{"schema_version":1,"projects":[]}'`]},
